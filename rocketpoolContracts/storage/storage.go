...
// GetNodePendingWithdrawalAddress is a free data retrieval call binding the contract method 0xfd412513.
//
// Solidity: function getNodePendingWithdrawalAddress(address _nodeAddress) view returns(address)
func (_Storage *StorageCaller) GetNodePendingWithdrawalAddress(opts *bind.CallOpts, _nodeAddress common.Address) (common.Address, error) {
	var out []interface{}
	err := _Storage.contract.Call(opts, &out, "getNodePendingWithdrawalAddress", _nodeAddress)
...
//
// Solidity: function getNodePendingWithdrawalAddress(address _nodeAddress) view returns(address)
func (_Storage *StorageSession) GetNodePendingWithdrawalAddress(_nodeAddress common.Address) (common.Address, error) {
	return _Storage.Contract.GetNodePendingWithdrawalAddress(&_Storage.CallOpts, _nodeAddress)
}

// GetNodePendingWithdrawalAddress is a free data retrieval call binding the contract method 0xfd412513.
//
// Solidity: function getNodePendingWithdrawalAddress(address _nodeAddress) view returns(address)
func (_Storage *StorageCallerSession) GetNodePendingWithdrawalAddress(_nodeAddress common.Address) (common.Address, error) {
	return _Storage.Contract.GetNodePendingWithdrawalAddress(&_Storage.CallOpts, _nodeAddress)
}

// GetNodeWithdrawalAddress is a free data retrieval call binding the contract method 0x5b49ff62.
//
// Solidity: function getNodeWithdrawalAddress(address _nodeAddress) view returns(address)
func (_Storage *StorageCaller) GetNodeWithdrawalAddress(opts *bind.CallOpts, _nodeAddress common.Address) (common.Address, error) {
	var out []interface{}
	err := _Storage.contract.Call(opts, &out, "getNodeWithdrawalAddress", _nodeAddress)
...
//
// Solidity: function getNodeWithdrawalAddress(address _nodeAddress) view returns(address)
func (_Storage *StorageSession) GetNodeWithdrawalAddress(_nodeAddress common.Address) (common.Address, error) {
	return _Storage.Contract.GetNodeWithdrawalAddress(&_Storage.CallOpts, _nodeAddress)
}

// GetNodeWithdrawalAddress is a free data retrieval call binding the contract method 0x5b49ff62.
//
// Solidity: function getNodeWithdrawalAddress(address _nodeAddress) view returns(address)
func (_Storage *StorageCallerSession) GetNodeWithdrawalAddress(_nodeAddress common.Address) (common.Address, error) {
	return _Storage.Contract.GetNodeWithdrawalAddress(&_Storage.CallOpts, _nodeAddress)
}
...
// ConfirmWithdrawalAddress is a paid mutator transaction binding the contract method 0xbd439126.
//
// Solidity: function confirmWithdrawalAddress(address _nodeAddress) returns()
func (_Storage *StorageTransactor) ConfirmWithdrawalAddress(opts *bind.TransactOpts, _nodeAddress common.Address) (*types.Transaction, error) {
	return _Storage.contract.Transact(opts, "confirmWithdrawalAddress", _nodeAddress)
}

// ConfirmWithdrawalAddress is a paid mutator transaction binding the contract method 0xbd439126.
//
// Solidity: function confirmWithdrawalAddress(address _nodeAddress) returns()
func (_Storage *StorageSession) ConfirmWithdrawalAddress(_nodeAddress common.Address) (*types.Transaction, error) {
	return _Storage.Contract.ConfirmWithdrawalAddress(&_Storage.TransactOpts, _nodeAddress)
}

// ConfirmWithdrawalAddress is a paid mutator transaction binding the contract method 0xbd439126.
//
// Solidity: function confirmWithdrawalAddress(address _nodeAddress) returns()
func (_Storage *StorageTransactorSession) ConfirmWithdrawalAddress(_nodeAddress common.Address) (*types.Transaction, error) {
	return _Storage.Contract.ConfirmWithdrawalAddress(&_Storage.TransactOpts, _nodeAddress)
}
...
// SetWithdrawalAddress is a paid mutator transaction binding the contract method 0xa543ccea.
//
// Solidity: function setWithdrawalAddress(address _nodeAddress, address _newWithdrawalAddress, bool _confirm) returns()
func (_Storage *StorageTransactor) SetWithdrawalAddress(opts *bind.TransactOpts, _nodeAddress common.Address, _newWithdrawalAddress common.Address, _confirm bool) (*types.Transaction, error) {
	return _Storage.contract.Transact(opts, "setWithdrawalAddress", _nodeAddress, _newWithdrawalAddress, _confirm)
}

// SetWithdrawalAddress is a paid mutator transaction binding the contract method 0xa543ccea.
//
// Solidity: function setWithdrawalAddress(address _nodeAddress, address _newWithdrawalAddress, bool _confirm) returns()
func (_Storage *StorageSession) SetWithdrawalAddress(_nodeAddress common.Address, _newWithdrawalAddress common.Address, _confirm bool) (*types.Transaction, error) {
	return _Storage.Contract.SetWithdrawalAddress(&_Storage.TransactOpts, _nodeAddress, _newWithdrawalAddress, _confirm)
}

// SetWithdrawalAddress is a paid mutator transaction binding the contract method 0xa543ccea.
//
// Solidity: function setWithdrawalAddress(address _nodeAddress, address _newWithdrawalAddress, bool _confirm) returns()
func (_Storage *StorageTransactorSession) SetWithdrawalAddress(_nodeAddress common.Address, _newWithdrawalAddress common.Address, _confirm bool) (*types.Transaction, error) {
	return _Storage.Contract.SetWithdrawalAddress(&_Storage.TransactOpts, _nodeAddress, _newWithdrawalAddress, _confirm)
}
...
// StorageNodeWithdrawalAddressSetIterator is returned from FilterNodeWithdrawalAddressSet and is used to iterate over the raw logs and unpacked data for NodeWithdrawalAddressSet events raised by the Storage contract.
type StorageNodeWithdrawalAddressSetIterator struct {
	Event *StorageNodeWithdrawalAddressSet // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *StorageNodeWithdrawalAddressSetIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(StorageNodeWithdrawalAddressSet)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *StorageNodeWithdrawalAddressSetIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *StorageNodeWithdrawalAddressSetIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// StorageNodeWithdrawalAddressSet represents a NodeWithdrawalAddressSet event raised by the Storage contract.
type StorageNodeWithdrawalAddressSet struct {
	Node              common.Address
...
// FilterNodeWithdrawalAddressSet is a free log retrieval operation binding the contract event 0xe04362a1cecc83cc66f0c6704a58da505fba1d6170f40e4543d477e76fa9175c.
//
// Solidity: event NodeWithdrawalAddressSet(address indexed node, address indexed withdrawalAddress, uint256 time)
func (_Storage *StorageFilterer) FilterNodeWithdrawalAddressSet(opts *bind.FilterOpts, node []common.Address, withdrawalAddress []common.Address) (*StorageNodeWithdrawalAddressSetIterator, error) {
	...
	logs, sub, err := _Storage.contract.FilterLogs(opts, "NodeWithdrawalAddressSet", nodeRule, withdrawalAddressRule)
	if err != nil {
		return nil, err
	}
	return &StorageNodeWithdrawalAddressSetIterator{contract: _Storage.contract, event: "NodeWithdrawalAddressSet", logs: logs, sub: sub}, nil
}

// WatchNodeWithdrawalAddressSet is a free log subscription operation binding the contract event 0xe04362a1cecc83cc66f0c6704a58da505fba1d6170f40e4543d477e76fa9175c.
//
// Solidity: event NodeWithdrawalAddressSet(address indexed node, address indexed withdrawalAddress, uint256 time)
func (_Storage *StorageFilterer) WatchNodeWithdrawalAddressSet(opts *bind.WatchOpts, sink chan<- *StorageNodeWithdrawalAddressSet, node []common.Address, withdrawalAddress []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _Storage.contract.WatchLogs(opts, "NodeWithdrawalAddressSet", nodeRule, withdrawalAddressRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(StorageNodeWithdrawalAddressSet)
				if err := _Storage.contract.UnpackLog(event, "NodeWithdrawalAddressSet", log); err != nil {
					return err
				}
				event.Raw = log
...
// ParseNodeWithdrawalAddressSet is a log parse operation binding the contract event 0xe04362a1cecc83cc66f0c6704a58da505fba1d6170f40e4543d477e76fa9175c.
//
// Solidity: event NodeWithdrawalAddressSet(address indexed node, address indexed withdrawalAddress, uint256 time)
func (_Storage *StorageFilterer) ParseNodeWithdrawalAddressSet(log types.Log) (*StorageNodeWithdrawalAddressSet, error) {
	event := new(StorageNodeWithdrawalAddressSet)
	if err := _Storage.contract.UnpackLog(event, "NodeWithdrawalAddressSet", log); err != nil {
		return nil, err
	}
